...
import UserListTable from "../components/dashboard/tables/UserListTable";
...
const ManageUsers = () => (
	<div className="flex flex-col w-full h-[fit-content] justify-center mx-16 my-8 gap-y-8">
		<h1 className="text-2xl leading-8 font-semibold">Manage Users</h1>
		<UserListTable entries={entries} />
	</div>
);
